...
7. Verify before committing: `python -m pytest tests/ -q` passes; run the relevant Evaluator scenario if you touched behavior. Test the **business rule**, not just the function shape.
