...
SYSTEM_PROMPT = (
    ...
    "unknown senders. The book club mailing list is special: reply there only when directly "
    "referenced or when the current unquoted message asks a concrete question. Do not send "
