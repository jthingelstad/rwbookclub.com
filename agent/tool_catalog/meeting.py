    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "member": {
                    "type": "string",
                    "description": "Optional member slug or name to scope to.",
                },
                "category": {
                    "type": "string",
                    "enum": [
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "date": {
                    "type": "string",
                    "description": "When it happened/will happen (YYYY-MM-DD).",
                },
                "summary": {
                    "type": "string",
                    "description": "One factual sentence describing the event.",
                },
                "member": {
                    "type": "string",
